...
public class NativeTools {
    ...
    public static native byte[] getVerifyCodeCheckFromJNI(byte[] szId,byte[] code,int checkId,int reserve);

    public static native byte[] genTradePacketKeyExchangePackFromJNI();
    ...
    public static native byte[] genTradeHeartPackFromJNI();
}
